...
All work must use subagents. The main conversation (Sonnet by default) coordinates and synthesizes. The user will manually switch to Opus when needed for complex tasks or planning. Subagents run in parallel when tasks are independent.
